...
try {
    ...
    console.log(addressBook.editContact("Manish", { address: "Raura", city: "London", phone: "9234567890" }));
    ...
    const duplicateContact = new Contact(
        "Manish", "Patel", "Bhopal", "India", "Madhya Pradesh", "462001", "9876543270", "helloiworld@gmail.com"
    );
